...
4. Access to `repo.ops.e2open.com/dcops-docker-repo` for the Tavi images used in Kubernetes workloads. The `regcred` secret must carry credentials for this registry.
